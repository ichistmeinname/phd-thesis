...
\newminted{haskell}{style=bw,frame=lines,framerule=0.05pt, framesep=7.5pt,mathescape=true,escapeinside=<>}
\newminted{coq}{style=bw,mathescape=true,escapeinside=!!}
\newminted[curry]{haskell}{style=bw,mathescape=true,escapeinside=<>}
