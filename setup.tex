...
% for footnotes following punctation
\usepackage{fnpct}
...
% add comment for references in the appendix
...
\newcommand{\thesisDate}{October, 2019}
\newcommand{\thesisVersion}{Version for Submission}

\newcommand{\thesisFirstReviewer}{Prof. Dr. Michael Hanus}
\newcommand{\thesisFirstReviewerUniversity}{Christian-Albrechts-Universit\"at zu Kiel}

\newcommand{\thesisSecondReviewer}{Prof. Dr. Janis Voigtl\"ander}
\newcommand{\thesisSecondReviewerUniversity}{Universit\"at Duisburg-Essen}

\newcommand{\thesisFirstSupervisor}{\thesisFirstReviewer}
\newcommand{\thesisSecondSupervisor}{John Smith}
\newcommand{\thesisUniversity}{Kiel University}
\newcommand{\thesisUniversityDepartment}{Department of Programming Languages and Compiler Construction}
...
% make additional pass for linebreaks
\emergencystretch=1em


% minted-related definitions
\newminted{haskell}{mathescape=true,escapeinside=<>}
\newminted{coq}{mathescape=true,escapeinside=!!}
\newminted[curry]{haskell}{mathescape=true,escapeinside=<>}
\newmintinline[cyinl]{haskell}{style=bw}
\newmintinline[hinl]{haskell}{style=bw}
\newmintinline[cinl]{coq}{escapeinside=!!,mathescape=true,style=bw}
