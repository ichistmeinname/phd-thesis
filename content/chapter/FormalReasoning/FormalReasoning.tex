...
Let us, for example, consider the Curry expression \hinl{0 ? (failed ? 1)}
...
\cinl{doublePlus oneOrTwo} and \cinl{doubleShare oneOrTwo}.
Since the representation using trees is more convenient, we will
transform the expressions in questions in to a tree representation
first.
