...
What's the first free monad paper to cite?
\cite{swierstra2008data}

\cite{mcbride2015turingcompleteness}
Interaction Trees (DeepSpec) \cite{koh2019interaction} (using \cite{kiselyov2015freer})
FreeSpec \cite{letan2018modular}

\cite{atkey2015interleaving}
