...
apply \cinl{doublePlus} on all values of the position function
\cinl{pf} yields for the given position \cinl{p}.

In contrast, the implementation of \cinl{doublePlus} simplifies to the
