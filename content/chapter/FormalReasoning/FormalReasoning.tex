...
Fortunately, \cite{abbott2005containers} introduced the notion of
...
Since we are mainly interested in monads, we can go even further and use
monadic containers as proposed by \cite{monadic2018altenkirch} and
\cite{partiality2017uustalu}.
...
over all possible type constructors but over all strictly positive types.
