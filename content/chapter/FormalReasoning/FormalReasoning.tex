...
The other mechanism the representation of effects needs to offer is a way to apply functions to the pure value; in case of \cinl{partial} we have used pattern matching to unwrap the pure values in order the define \cinl{head} and \cinl{append}.
