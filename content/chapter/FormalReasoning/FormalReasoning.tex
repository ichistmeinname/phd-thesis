...
\citet{abel2005verifying}, who translated Haskell code into Agda~\citep{norell2008dependently} code
...
semantics.
In a first attempt to investigate the current approach \todo{cite
  haskell paper}, we took a more
...
Symposium on Haskell \citep{christiansen2019verifying}. \todo{cite
  haskell paper}
