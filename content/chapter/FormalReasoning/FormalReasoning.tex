...
We introduce the function argument \cinl{p} using \cinl{extensionality p} and end up with \cinl{p : One__P s} added to the assumptions and a changed goal as follows.
