...
computation \cinl{oneOrTwo} yields \cinl{TTrue} and \cinl{TTrue}
...
generalised to a difference between call-by-name and call-by-need.
In the following, we will compare our example definition of
