...
Recall that we defined the data type \cinl{One} and its corresponding container representation in \autoref{sub:container}.
...
That is, we use the following container representation of \cinl{One} described as a type of shapes and a position type function.
...
More precisely, we defined two functions \cinl{from_One} and \cinl{to_One}, and show that both compositions yield the identity.
...
Next up, we can also show that the resulting \cinl{Free One!$_\text{S}$!}  is isomorphic to the monadic structure \cinl{partial}.
...
For a better readability, we added the suffix \cinl{P} for this version of \cinl{append} that uses \cinl{partial}.
...
\cinl{Pos s -> Free A}.
The is that we just need to reconstruct the effect that we have seen, characterised by its shape \cinl{s}, and apply the function \cinl{f} recursively for all recursive occurrences of the effect that we can access using the position function \cinl{pf}.
...
That is, the container representing totality has neither a position nor a shape, thus, programs modeled as \cinl{Free Zero!$_\text{S}$! Zero!$_\text{P}$!} do not have any \cinl{impure} values by construction.
...
\begin{minted}[escapeinside=!!,mathescape=true]{coq}
  A : Type
  fx : Free Zero!$_\text{S}$! Zero!$_\text{P}$! A
  fxs, fys, fzs : Free Zero!$_\text{S}$! Zero!$_\text{P}$! (List Zero!$_\text{S}$! Zero!$_\text{P}$! A)
...
\begin{minted}[escapeinside=!!,mathescape=true]{coq}
  A : Type
  s : Zero!$_\text{S}$!
  pf : Zero!$_\text{P}$! s -> Free Zero!$_\text{S}$! Zero!$_\text{P}$! (List Zero!$_\text{S}$! Zero!$_\text{P}$! A)
  fys, fzs : Free Zero!$_\text{S}$! Zero!$_\text{P}$! (List Zero!$_\text{S}$! Zero!$_\text{P}$! A)
  ============================
