...
\cite{abel2005verifying}

Sparkle \citep{demol2002theorem} \citep{vaneekelen2006proof}
(strictness checks)

Hermit \cite{farmer2015reasoning} (pen-and-paper proofs from \cite{bird2010pearls})

\cite{dijkstra2012experimentation} (partial functions are translated
using \cite{bove2007computation})

\cite{spector-zabusky2018total}; case study and different approach for
partial functions in \cite{breitner2018ready}
