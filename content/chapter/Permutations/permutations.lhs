...
More generally, for $n \geq 7$ we have that $n \leq 2^{\frac{n-1}{2}}$ such that we can make the following estimation.\footnote{We prove the first inequation by induction in \appref{sec:appendix:inequation}.}.
