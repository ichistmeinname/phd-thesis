...
Besides showing that the output list cannot be of different length than the input list, we can also show that for all possible output lists \cinl{ys : vector B m} that fulfil the specification predicate, it must hold that the output list is of the same length as the input list.
