...
One of these arguments is the proposition \cinl{P : list A -> Prop} of the induction principle, which Coq proves automatically because it can be inferred from the goal we apply the function to.
...
A container extension of type \cinl{Ext Shape Pos} consists of a function \cinl{Pos s -> A} for all shapes \cinl{s : Shape} that gives access to the polymorphic components of the data type it describes.
