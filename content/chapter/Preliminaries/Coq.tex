...
As the first thing we do for both cases of the induction is to simplify the given goal using the definition \cinl{vmap}, we use the notation \cinl{tactic1; tactic2} to apply the second tactic \cinl{simpl} on all subgoals generated by the first tactic \cinl{induction}.
